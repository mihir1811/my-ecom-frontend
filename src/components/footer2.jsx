        ...
        <div className='max-w-[1300px] mx-auto'>
            ...
            <div className="grid max-sm:grid-cols-1 max-lg:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <ul className="space-y-4">
                    <li><a href="/" className="text-gray-500 hover:text-gray-800 text-[15px]">Web
                    Development</a></li>
                    <li><a href="/" className="text-gray-500 hover:text-gray-800 text-[15px]">Mobile App
                    Development</a></li>
                    <li><a href="/" className="text-gray-500 hover:text-gray-800 text-[15px]">UI/UX
                    Design</a></li>
                    <li><a href="/" className="text-gray-500 hover:text-gray-800 text-[15px]">Digital Marketing</a></li>
                </ul>
                </div>
                ...
                <ul className="space-y-4">
                    <li><a href="/" className="text-gray-500 hover:text-gray-800 text-[15px]">Webinars</a>
                    </li>
                    <li><a href="/" className="text-gray-500 hover:text-gray-800 text-[15px]">Ebooks</a>
                    </li>
                    <li><a href="/" className="text-gray-500 hover:text-gray-800 text-[15px]">Templates</a>
                    </li>
                    <li><a href="/" className="text-gray-500 hover:text-gray-800 text-[15px]">Tutorials</a></li>
                </ul>
                </div>

                <div>
                <h4 className="text-lg font-bold mb-6 text-gray-800">Social Media</h4>
                <ul className="space-y-4">
                    <li><a href="/" className="text-gray-500 hover:text-gray-800 text-[15px]">Our Story</a>
                    </li>
                    <li><a href="/" className="text-gray-500 hover:text-gray-800 text-[15px]">Mission and
                    Values</a></li>
                    <li><a href="/" className="text-gray-500 hover:text-gray-800 text-[15px]">Team</a></li>
                    <li><a href="/" className="text-gray-500 hover:text-gray-800 text-[15px]">Testimonials</a></li>
                </ul>
                </div>
            </div>
        </div>
