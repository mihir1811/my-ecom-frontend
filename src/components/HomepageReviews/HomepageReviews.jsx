          ...
          <div className="bg-white rounded-full p-10 min-h-[600px] flex items-center flex-col justify-center">
            <div className="flex items-center mb-4">
              ...
              <div className="ms-3 w-full">
                <h4 className="capitalize font-semibold">Alina</h4>
                <p className="capitalize text-[14px]">fashion blogger</p>
              </div>
            </div>
            <p>
              Lorem ipsum dolor sit amet, consectetur adat obcaecatibusfacere
              magni tota totam. Perferendis maiores veritatis illo ex doloremque
              assumenda asperiores, similique libero vel officiis quisquam
              earum, id, sit architecto consequuntur velit. Quam tempora
              asperiores culpa laboriosam. Non!
            </p>
          </div>
          <div className="bg-white rounded-full p-10 min-h-[600px] flex items-center flex-col justify-center">
            <div className="flex items-center mb-4">
