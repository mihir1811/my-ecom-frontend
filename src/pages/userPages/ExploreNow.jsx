...
const ExploreNow = () => {
  return (
    <div className="flex justify-center items-center px-16 py-20 text-6xl font-medium bg-white rounded-[1000px_1000px_0px_0px] text-stone-600 max-md:px-5 max-md:text-4xl">
      <div className="flex flex-col mt-20 ml-16 max-w-full w-[766px] max-md:mt-10 max-md:text-4xl">
        ...
        <div className="justify-center items-center self-center px-9 py-2.5 mt-32 max-w-full text-3xl font-semibold text-center font-rossa text-[#5877C7] bg-neutral-100 shadow-sm rounded-[52.913px] w-[352px] max-md:px-5 max-md:mt-10">
          Explore Now
        </div>
      </div>
    </div>
